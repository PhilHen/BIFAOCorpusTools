#Ce script python crée les fichiers d'un corpus (avec méta-données) au format TEI-XML dans le répertoire de sortie
...
docTitle="Alliot_1961_1961@02_FrançoisDaumas.xml"   #to change
docId="1961_02"
...
corpusOutputFolder=r"E:\personal\EtudesEgyptologie\DigitalResearch\BIFAOCorpus\Corpuses\Test1"
...
for row in metadataList:
    if row[langCol]=="F" and row[idCol]=="BIFAO096_art_03.pdf":            #critère de sélection du corpus
        ...
        dMetadata={"Auteur": row[authorCol], "Annee":str(row[yearCol])}
        if isNecro:
        ...
        sSourceURL="https://www.ifao.egnet.net/bifao/"+str(int(bulletinID[-3:]))+"/"+str(int(articleWithinBulletinID))+"/"
        sFootnotes=""
